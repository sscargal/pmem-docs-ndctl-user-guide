...
[NAME](ndctl-update-passphrase.md#name)  
[SYNOPSIS](ndctl-update-passphrase.md#synopsis)  
[DESCRIPTION](ndctl-update-passphrase.md#description)  
[OPTIONS](ndctl-update-passphrase.md#options)  
[THEORY OF OPERATION](ndctl-update-passphrase.md#theory-of-operation)  
[COPYRIGHT](ndctl-update-passphrase.md#copyright)  
[SEE ALSO](ndctl-update-passphrase.md#see-also)
...
_ndctl update−passphrase_  &lt;nmem0&gt; \[&lt;nmem1&gt;..&lt;nmemN&gt;\] \[&lt;options&gt;\]

## DESCRIPTION

Update the security passphrase for one or more NVDIMMs. Prerequisites for command to succeed:

1. The _kek_ has been loaded into the kernel’s user keyring.
...
[ndctl−setup−passphrase\(1\)](ndctl-setup-passphrase.md), [ndctl−remove−passphrase\(1\)](ndctl-remove-passphrase.md)
